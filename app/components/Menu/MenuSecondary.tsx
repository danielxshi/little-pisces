...
export default function MenuSecondary(props: {
  ...
  return (
    <div className="container pt-32 lg:grid lg:grid-cols-12 food-menu ">
      <div className="col-start-2 col-end-7 relative">
        ...
        <div className="food-image-container h-4/5 relative w-4/5 justify-end ml-auto flex z-100 mt-24 -mr-8 -mb-8">
          <ContentfulImage src={props.image} fill={true} objectFit="cover" />
        </div>
      </div>
      <div className="col-start-7 col-end-13 bg-white lg:px-32 px-8 py-16 text-black justify-center align-middle flex flex-col pt-48">
