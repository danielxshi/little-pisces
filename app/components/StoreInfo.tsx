      ...
      <div className=" relative overflow-hidden flex flex-col ">
        ...
        >
          <section className="container md:py-16 md:grid md:grid-cols-12 flex flex-wrap">
            <div className="store-hours px-8 flex flex-col col-start-1 col-end-7 w-full py-8 m-8 md:m-0">
              <h2 className="text-5xl mb-8">Opening Hours</h2>
              <ul className="flex flex-col w-full">
                {ProjectMessages.OperationHours.map((item, index) => (
                  <li className="w-full lg:w-6/7 text-2xl mb-4 flex justify-between">
                    <span>{item.day}</span>
