          ...
          <ul className="w-full">
            {ProjectMessages.MenuTaiyaki.map((item, index) => (
              <li className="w-full flex  mb-[-2.5rem]">
                <div className="w-24 h-24 md:ml-[-1.5rem] min-w-[100px] max-w-[100px] min-h-[100px] max-h-[120px]">
                  <ContentfulImage
                ...
                <div className="flex w-4/5 text-left ml-6">
        ...
        <div className="w-full">
          <ul className="w-full">
            {ProjectMessages.MenuSoftServe.map((item, index) => (
              <li className="w-full flex  mb-[-2.5rem] ">
                <div className="w-26 h-26 md:ml-[-1.5rem] min-w-[100px] max-w-[100px] min-h-[100px] max-h-[120px]">
                  <ContentfulImage
                    src={`/images/menu-icons/${item.image}`}
                    fill={true}
                    objectFit="contain"
          ...
          <ul className="w-full">
            {ProjectMessages.MenuDrinks.map((item, index) => (
              <li className="w-full flex  md:mb-[-2.5rem] mb-[-2.5rem]">
                ...
                <div className="flex w-full text-left ml-6">
                  <span className="text-xl self-center">{item.name}</span>
                </div>
                <span className="md:mr-32 text-xl self-center ml-6">
                  {item.price}
                </span>
              </li>
            ))}
